...
-- 1. FIX: Roadmap Items - Replace insecure admin checks with role-based function
-- ============================================
...
-- 2. FIX: Suggestions - Replace insecure admin checks with role-based function
-- ============================================
...
-- 3. FIX: Profiles - Update to use role-based function instead of is_admin
-- ============================================
...
-- Coupons are now only accessible via edge function validation
...
-- 6. ADD: Coupon code validation constraint
-- ============================================
