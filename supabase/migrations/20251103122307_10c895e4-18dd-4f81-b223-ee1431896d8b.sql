...
DROP FUNCTION IF EXISTS update_produto_with_cast;
...
BEGIN
  ...
  SET 
    ...
    unidade = p_unidade::unidade_medida,
...
COMMENT ON FUNCTION update_produto_with_cast IS 'Função RPC para atualizar produtos com cast explícito de text para unidade_medida';